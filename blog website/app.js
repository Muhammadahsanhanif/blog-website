      ...
      <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-4">
          ...
          <div class="flex justify-between items-center"> 
           <button class="block w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">read more
 </button>
          </div>
        </div>
      </div>
